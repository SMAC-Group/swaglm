...
// 
// // [[Rcpp::export]]
// arma::mat compute_all_possible_variable_combinations_cpp(const arma::mat& originalMatrix, const std::vector<int>& idScreening) {
//   int nrv = originalMatrix.n_rows;
//   int d = originalMatrix.n_cols + 1; // New number of columns
//   int numScreening = idScreening.size();
// 
